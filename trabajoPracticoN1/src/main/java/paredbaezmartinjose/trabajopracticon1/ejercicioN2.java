...
public class ejercicioN2 {
    public static void main(String[] args) {
        ...
        System.out.println("Nota media, mayor y menor de una serie de Alumnos");
        System.out.println("-------------------------------------------------");

        do {
            System.out.print("Introduce numero de alumnos: ");
            n = sc.nextInt();  //n contiene el número de alumnos
        } while (n <= 0); //repetir mientras que el valor de n sea <= 0 asi la cantidad de alumnos no es 0
